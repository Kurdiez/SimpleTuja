export enum AppRoute {
  Dashboard = "/app",
  CryptoLending = "/app/crypto-lending",
  CryptoLendingOnboarding = "/app/crypto-lending/onboarding",
  CryptoLendingOnboardingAbout = "/app/crypto-lending/onboarding/about",
  ...
  CryptoLendingActiveLoans = "/app/crypto-lending/active-loans",
