...
const BlurIcon: React.FC<BlurIconProps> = ({ className = "w-6 h-6" }) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
    ...
    className={className}
  >
    <circle cx="12" cy="12" r="12" fill="#080404" />
    <path d="M6 14.6406V15.5345H7.42858V14.6406H6Z" fill="#FF8700" />
    <path
      d="M10.1428 14.6406V15.5345H11.5714V14.6406H10.1428Z"
      fill="#FF8700"
    />
    <path d="M7.42858 15.832H6V16.5769H7.42858V15.832Z" fill="#FF8700" />
    <path d="M13.857 8.68138V7.93652H12.4285V8.68138H13.857Z" fill="#FF8700" />
    <path
      d="M7.49854 11.7995V7.125H9.94426L10.2128 7.42294V7.99596H11.5714V7.125L11.2357 6.74512H6.14282V11.7995H7.49854Z"
      fill="#FF8700"
    />
    <path d="M13.857 8.97949H12.4285V9.87332H13.857V8.97949Z" fill="#FF8700" />
    <path d="M10.1428 15.832V16.5769H11.5714V15.832H10.1428Z" fill="#FF8700" />
    <path
    ...
    <path
      ...
      fill="#FF8700"
    />
    <path d="M13.857 6H12.4285V10.5136H13.857V6Z" fill="#FF8700" />
    <path
    ...
    <path
      ...
      fill="#FF8700"
    />
    <path d="M13.857 12.96H12.4285V18.5135H13.857V12.96Z" fill="#FF8700" />
    <path d="M6 13.9135V14.3425H7.42858V13.5977H6V13.9135Z" fill="#FF8700" />
    <path
    ...
    <path
      ...
      fill="#FF8700"
    />
    <path d="M13.857 16.875H12.4285V17.7688H13.857V16.875Z" fill="#FF8700" />
    <path d="M7.42858 12.7041H6V16.9782H7.42858V12.7041Z" fill="#FF8700" />
  </svg>
);
